...
const styles = StyleSheet.create({
  ...
  hello: { color: "#1E293B", fontSize: 27, fontWeight: "800", lineHeight: 34 },
  supporting: { color: "#64748B", fontSize: 14, lineHeight: 20 },
  ...
  sectionTitle: { color: "#334155", fontSize: 18, fontWeight: "800" },
